const convertedVapidKey = urlBase64ToUint8Array("BMZSEAvmZhbfM36WDoJou2vnyVAXNeUyqOrC22pi9dEsfPc_UWEeQEf8Mt9yfoh21TKOc9KN86wUX5FnlSb3zXs")
...
function sendSubscription(subscription) {
  return fetch(`http://localhost:7500/notifications/subscribe`, {
    method: 'POST',
    body: JSON.stringify({
